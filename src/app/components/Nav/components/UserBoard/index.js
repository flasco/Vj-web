...
class UserBoard extends React.PureComponent {
  ...
  render() {
    const { icon, accountName, uid, userBoardHover, onMouseLeave, onMouseEnter, acCount, failCount } = this.props;
    return (
...
function select(state) {
  return {
    ...
    failCount: state.user.failCount,
  };
}
